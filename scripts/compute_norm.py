...
def main() -> None:
    parser = argparse.ArgumentParser(description="Compute LingBot-VLA normalization stats for AlohaMini2Pro.")
    parser.add_argument("--lingbot_repo", default=str(DEFAULT_LINGBOT_REPO))
    parser.add_argument("--config", default=str(DEFAULT_CONFIG))
    parser.add_argument("--entrypoint", default="scripts/compute_norm.py")
